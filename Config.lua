				...
				misdirections = {
					...
					args = {
						...
						misdirectionraid = {
							type = 'toggle',
							name = L["Warn to raid chat"],
							desc = "Warn to raid chat when Misdirection or Tricks of the Trade is cast",
							get = function(info) return RaidBuffStatus.db.profile.misdirectionraid end,
							set = function(info, v)
								RaidBuffStatus.db.profile.misdirectionraid = v
							end,
							order = 3,
						},
						misdirectionparty = {
							type = 'toggle',
							name = L["Warn to party"],
							desc = "Warn to party when Misdirection or Tricks of the Trade is cast",
							get = function(info) return RaidBuffStatus.db.profile.misdirectionparty end,
							set = function(info, v)
								RaidBuffStatus.db.profile.misdirectionparty = v
							end,
							order = 4,
						},
						misdirectiontest = {
