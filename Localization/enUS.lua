...
L["Blessing of Might/Battle Shout"] = true
L["Commanding Shout/Blood Pact"] = true
L["Stoneskin Totem"] = true
L["Strength of Earth Totem"] = true
L["Wind Fury Totem"] = true
L["Totem of Wrath"] = true
L["Wrath of Air Totem"] = true
L["Flame Tongue Totem"] = true
...
L["Allow reporting to raid without assist/leader"] = true
L["Allows the reporting of missing buffs to the raid without an assist or leader right."] = true
